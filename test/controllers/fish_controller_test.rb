...
class FishControllerTest < ActionController::TestCase
  ...
  test "should create fish" do
    assert_difference('Fish.count') do
      post :create, fish: { caught: @fish.caught, description: @fish.description, latitude: @fish.latitude, longitude: @fish.longitude, name: @fish.name }
    end
  ...
  test "should update fish" do
    patch :update, id: @fish, fish: { caught: @fish.caught, description: @fish.description, latitude: @fish.latitude, longitude: @fish.longitude, name: @fish.name }
    assert_redirected_to fish_path(assigns(:fish))
  end
